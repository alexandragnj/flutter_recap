import 'package:flutter_recap/services/auth/auth_exceptions.dart';
import 'package:flutter_recap/services/auth/auth_provider.dart';
import 'package:flutter_recap/services/auth/auth_user.dart';
...
void main() {
  group('Mock Authentication', () {
    ...
    test('Cannot logout iif not initialized', () {
      expect(
        provider.logOut(),
